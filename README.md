...
According we designing, all Trojan Plus mobile client app should be in same UI with same user experience, that's why this project exists. Beside the core library [Trojan Plus](https://github.com/Trojan-Plus-Group/trojan-plus), we also use [.NET MAUI](https://dotnet.microsoft.com/en-us/apps/maui) to build this app including Android and iOS. 
